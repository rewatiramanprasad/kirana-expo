...
const CustomerCard = ({
  ...
  const handlePress = (member) => {
    console.log('Pressed member:', member)
    navigator.navigate('MemberDetails', { data:member})
  }
  return (
    <TouchableOpacity onPress={() => handlePress(member) } className="bg-cardBackground rounded-2xl p-4 mb-2">
